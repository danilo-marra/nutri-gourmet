...
| Operations     | Cash close: not blocking (`pending` status), generates basic summary, supervisor/admin can close on behalf of operator; operator account creation: supervisor/admin → email invite; supervisor account creation: admin only | `raw/decisions/operacoes.md`      |
