...
| Operations     | Cash close: not blocking (`pending` status), generates basic summary, supervisor/admin can close on behalf of operator; account creation: supervisor/admin → email invite via existing activation flow    | `raw/decisions/operacoes.md`      |
